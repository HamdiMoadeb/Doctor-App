...
class AppointmentDetails extends StatefulWidget {
  ...
  AppointmentDetailsState createState() =>
      new AppointmentDetailsState(appointment: appointment);
}
...
class AppointmentDetailsState extends State<AppointmentDetails> {
    ...
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: Text('Are you sure to cancel this appointment ?'),
            actions: <Widget>[
              new FlatButton(
                  child: const Text('NO'),
                  onPressed: () {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Details rendez-vous'),
      ),
      body: Padding(
